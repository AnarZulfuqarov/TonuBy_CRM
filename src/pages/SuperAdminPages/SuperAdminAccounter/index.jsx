...
const SuperAdminAccounter
    ...
    return (
        <div className="super-admin-accounter-main">
            <div className="super-admin-accounter">
                <div className={"headerr"}>
                    ...
                    <div>
                        <button onClick={()=>navigate("/superAdmin/accounter/accounterAdd")}>
                            ...
                            <span>Mühasib əlavə et</span></button>
                    </div>
                </div>
            ...
            {deleteIndex !== null && (
                <div className="modal-overlay" onClick={() => setDeleteIndex(null)}>
                    <div className="delete-modal-box" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="delete-message">Mühasibi silmək istədiyinizə əminsiz?</p>
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    try {
                                        ...
                                        showPopup("Mühasibi sildiniz","Seçilmiş mühasib sistemdən uğurla silindi","success")
                                        setDeleteIndex(null);
                                        refetch();
                                    } catch  {
                                        showPopup("Sistem xətası","Əməliyyat tamamlanmadı. Təkrar cəhd edin və ya dəstəyə müraciət edin.","error")
...
export default SuperAdminAccounter
;