...
const SuperAdminSupplierDetail = () => {
    const {id} = useParams();
    ...
    const companies = customer?.companyDtos || [];
    const [deleteSection] = useDeleteFighterBolmeMutation()
    ...
    const handleSearchClick = () => {
        setActiveSearch(activeSearch === 'name' ? null : 'name');
        setSearchName('');
    };
    ...
    return (
        <div className="super-admin-supplier-detail-main">

            <div className="super-admin-supplier-detail">
                <div className={"headerr"}>
                    <div className={"head"}>
                        <h2>Təchizatçının icazəsi olduğu şirkətlər</h2>
                        <p>Burada təchizatçıların hansı sistem şirkətlərə giriş və səlahiyyətlərinin olduğunu görə
                            bilərsiniz.</p>
                    </div>
                    <div>
                        <button onClick={() => navigate(`/superAdmin/supplier/${id}/bolmeAdd`)}>
                            ...
                            <span>Şirkət əlavə et</span></button>
                    </div>
                </div>
                <div className={"path"}>
                    <h2>
                                    ...
                                    {activeSearch === 'name' && (
                                        <div className="search-input-wrapper">
                                            <input
                                                ...
                                                placeholder="Search Şirkət"
                                                autoFocus
                                            />
                                            <span className="close-search" onClick={handleCloseSearch}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                    <path d="M12.5 3.5L3.5 12.5M3.5 3.5L12.5 12.5" stroke="#7A7A7A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                </svg>
                                            </span>
                                        </div>
                                    )}
  ...
  <path
      ...
      fill="#ED0303"/>
                ...
                <div className="super-admin-supplier-detail__pagination">
            ...
            {deleteIndex !== null && (
                <div className="modal-overlay" onClick={() => setDeleteIndex(null)}>
                    <div className="delete-modal-box" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="delete-message">Şirkəti silməyə əminsinizmi ?</p>
                        <div className="delete-modal-actions">
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    try {
                                        const companyId = pagedItems[deleteIndex].id;
                                        await deleteSection({ fighterId: id, companyId  });
                                        setDeleteIndex(null);
                                        refetch()
                                        showPopup("Şirkət icazəsi deaktiv edildi","Seçilmiş istifadəçinin şirkət icazəsini ləğv etdiniz","success")
                                    } catch  {
...
export default SuperAdminSupplierDetail;
