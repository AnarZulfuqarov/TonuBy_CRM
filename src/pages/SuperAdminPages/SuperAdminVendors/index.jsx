...
const SuperAdminVendors = () => {
    ...
    return (
        <div className="super-admin-vendors-main">
            <div className="super-admin-vendors">
                <div className={"headerr"}>
                    <div className={"head"}>
                        <h2>Vendorlar</h2>
                        <p>Buradan vendorları idarə edə və yenilərini yarada bilərsiniz.</p>
                    </div>
                    <button onClick={()=>navigate("/superAdmin/products/vendorAdd")}>
