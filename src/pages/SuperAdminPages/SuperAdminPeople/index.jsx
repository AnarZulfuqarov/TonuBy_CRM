                    ...
                    <div className="modal-content">
                        <button className="close-btn" onClick={() => setEditingUser(null)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                 fill="none">
                                <path d="M15.8333 4.16699L4.16663 15.8337M4.16663 4.16699L15.8333 15.8337"
                                      stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                        <h3>Burada istifadəçi məlumatlarını gözdən keçira və lazım olduqda dəyişiklik edə
                            bilərsiniz</h3>
                        <div className="form">
