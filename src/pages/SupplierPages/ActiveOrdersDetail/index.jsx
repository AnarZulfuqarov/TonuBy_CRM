            ...
            <div className="active-order-detail">
                ...
                <div className={"about"}>
                    <div className={"about-content"}>
                        <p>
                            Sifariş verən şirkət:
                            <span> {orderData?.section?.companyName || '—'} </span>
                        </p>
                        <p>
                            Sifariş verən şəxs:
                            <span> {orderData?.adminInfo?.surname} {orderData?.adminInfo?.name} </span>
                        </p>
                        <p>
                            Şöbə:
                            <span> {orderData?.section?.departmentName || '—'} </span>
                        </p>
                        <p>
                            Bölmə:
                            <span> {orderData?.section?.name || '—'} </span>
                        </p>
                    </div>
                        ...
                        <div className="modal-box">
                            ...
                            <div className={"closeIcon"} onClick={() => setSelectedRowIndex(null)}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                     fill="none">
                                    <path d="M12.6667 3.3335L3.33337 12.6668M3.33337 3.3335L12.6667 12.6668"
                ...
                <div className={"invoys"}>
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                        ...
                        />
                        <label className="upload-button" htmlFor="invoice-upload"><span>İnvoysi yükləyin</span>
