...
const SupplierProducts = () => {
    ...
    //request
    const {data:getProductAddMyPending} = useGetProductAddMyPendingQuery()
    const addRequests = getProductAddMyPending?.data
    const {data:getProductDeleteMyPending} = useGetProductDeleteMyPendingQuery()
                            ...
                            <table className="order-history-detail-supplier__table">
                                ...
                                {combinedRequests.map((item, i) => {
                                    ...
                                    return (
                                        <tr key={item.id}>
                                            <td>{item.name}</td>
                                            <td>{item.categoryName || 'Kateqoriya yoxdur'}</td>
                                            <td>{item.measure}</td>
                                            <td>
                                                <div style={{
                                                    display: 'flex',
