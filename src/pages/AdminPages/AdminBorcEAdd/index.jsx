...
export default function AdminBorcEAdd() {
    ...
    return (
        <div className="admin-borc-e-add-main">
            <div className="admin-borc-e-add">
                <div className="headerr">
                    <div className="head">
                        <h1>Yeni borc əməliyyatı</h1>
                    </div>
                    <h2>
                        <NavLink className="link" to="/admin/emeliyyat/borc-e">
                            — Şirkət seçimi
                        </NavLink>
                        <NavLink className="link" to={`/admin/emeliyyat/borc-e/${id}`}>
                            — {company?.name}
                        </NavLink>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        value={form.alinacaq}
                                        onChange={(e) => setForm((p) => ({ ...p, alinacaq: e.target.value }))}
                                    />
                                </td>
                                <td>
                                    <input
                                        ...
                                        value={form.verilecek}
                                        onChange={(e) => setForm((p) => ({ ...p, verilecek: e.target.value }))}
                                    />
                                </td>
                                <td
                                    onClick={() => {
