        ...
        <div className="admin-borc-e-main">
            <div className="admin-borc-e">
                <div className="header">
                    <div className="head">
                        <h2>Borc əməliyyatı(Şirkət seçimi)</h2>
                        <p>
                        ...
                        return (
                            <div key={company.id} className="company-card">
                                ...
                                <div className={"cardButton"} >
                                    Keçid et <button onClick={()=>navigate('/admin/emeliyyat/borc-e/:id')} style={{ backgroundColor: color }}> <svg xmlns="http://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5 8" fill="none">
