                            ...
                            <tr key={company.id}>
                                ...
                                <td>
                                    <div style={{ display: 'flex', justifyContent: 'center', gap: '12px' }}>
                                        <svg onClick={()=>navigate('/admin/companies/category/:id')} style={{cursor:"pointer"}} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            {deleteCompanyId  !== null && (
                <div className="modal-overlay" onClick={() => setDeleteCompanyId(null)}>
                    ...
                    <div className="delete-modal-box" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="delete-message">Kateqoriyanı silmək istədiyinizə əminsiz?</p>
