        ...
        <div className="admin-borc-h-main">
            <div className="admin-borc-h">
                <div className="header">
                    <div className="head">
                        <h2>Borc hesabatı (Şirkət seçimi)</h2>
                        <p>
                            Borc  hesabatını görmək istədiyiniz şirkəti seçin. Seçimdən sonra həmin şirkətə aid əməliyyatlar təqdim olunacaq.
                        </p>
                    </div>
                </div>
                        ...
                        return (
                            <div key={company.id} className="company-card">
                                ...
                                <div className={"cardButton"} >
                                    Keçid et <button onClick={()=>navigate(`/admin/hesabat/borc-h/${company.id}`)} style={{ backgroundColor: color }}> <svg xmlns="http://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5 8" fill="none">
