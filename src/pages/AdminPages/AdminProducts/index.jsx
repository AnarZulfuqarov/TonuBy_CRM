            ...
            <div className="admin-products">
                ...
                <div className={"root"}>
                    <h2 >
                        ...
                        <NavLink className="link" to="/admin/companies/:id">— Kateqoriya</NavLink>{' '}
                        — Məhsul
                    </h2>
                </div>
                <div className={"paths"}>
                    <div className="path1">
                        <h3>Şirkətin adı:</h3> <span>Premier </span>
                    </div>
                    <div className={'hrXettt'}></div>
                    <div className="path1">
                        <h3>Kateqoriya adı:</h3> <span>Premier </span>
                    </div>
                </div>
                ...
                <div className="vendor-edit-modal-overlay" onClick={() => setCreateModalVisible(false)}>
                    <div className="create-company-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-fields">
                            ...
                            <input
                                type="text"
                                placeholder="Barkod adı daxil et"
                                value={createName}
                            ...
                            <input
                                type="text"
                                placeholder="Ölçü vahidi daxil et"
                                value={createName}
                                onChange={(e) => setCreateName(e.target.value)}
                            />
            ...
            {deleteCompanyId  !== null && (
                <div className="modal-overlay" onClick={() => setDeleteCompanyId(null)}>
                    ...
                    <div className="delete-modal-box" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="delete-message">Məhsulu silmək istədiyinizə əminsiz?</p>
